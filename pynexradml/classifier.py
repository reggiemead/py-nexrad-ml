...
if __name__ == "__main__":
    ...
    parser.add_argument('-f', '--config', help='Use configureations from specified file unless specified on command line')
    ...
    parser.add_argument('--folds', type=int, help='Number of folds to use for cross validation')
    parser.add_argument('--hidden_nodes', type=int, help='Number of hidden nodes in the neural network')
    parser.add_argument('--learning', type=float, help='Learning rate (e.g. 0.1)')
    parser.add_argument('-o', '--output', help='Save classifier to an output file (e.g. nn.ml)')
    parser.add_argument('--sweep_threshold', type=float, help='Threshold to use for sweep level classifications (e.g. .7 = 70%)')
    parser.add_argument('-t', '--training_data', nargs='*', help='Datasets to use for training data (e.g. rd1 rd2)')
    parser.add_argument('--threads', type=int, help='Use specified number of threads')
